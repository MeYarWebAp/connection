...
with st.expander(""):
    st.markdown("<h5 style='text-align: center;'>معیار، ماشین جستجوگری هوشمند است که در هر ثانیه و بدون نیاز به کمک هیچ انسانی، دقیقا به انتخاب های شما گوش فرا می دهد و برای شکل گیری خانواده ای جدید، به طور آنلاین، لینک های قابل ارائه ای را به شما پیشنهاد می کند. ماشین معیار، هدف اقتصادی ندارد و بدون نیاز به کسب حقوق این کار را انجام می دهد. چند کلیک می تواند شما را از کوتاه ترین راه، در نقطه آغازین رابطه ای سالم قرار دهد. معیار، ماموریتی بیش از لینک کردن ندارد و پس از انجام ماموریت معرفی اولیه ماشینی، همه چیز را بر فرض اعتماد به هم و هوشمندی کاربران خود می گذارد</h5>", unsafe_allow_html=True )
...
if (num00==sp):
    ...
    st.markdown('<div style="text-align: center;color:Gray">معیارها و ویژگی های شما من بعد به طور خود به خود بار گذاری می شوند هر چند می توانید آن ها را هر لحظه تغییر دهید</div>', unsafe_allow_html=True)
