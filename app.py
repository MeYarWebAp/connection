...
with col120:
    with st.expander(""):
        st.markdown("<h5 style='text-align: center;color:lightblue'>معیار،ماشین جستجوگری هوشمند است که به طورخودکار، ۲۴ ساعته و هر ثانیه و بدون نیاز به کمک هیچ واسطه ای غیر از خود شما، می تواند به سلیقه های شما به طور دقیق گوش فرا دهد و برای شکل گیری خانواده ای جدید،  لینک هایی که معیارهای شما را دارا هستند به شما بشناساند. معیار، این کار را بر اساس درجه سخت گیری ای که خود شما تعیین می کنید، انجام می دهد. طرح معیار، هدف اقتصادی ندارد وکارکردی بیشتر از لینک کردن اولیه خودکار برای خود تعریف نکرده  است. معیار فرض را بر اعتماد و هوشمندی کاربران می گذارد</h5>", unsafe_allow_html=True )
