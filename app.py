...
with st.expander(""):
    st.markdown("<h5 style='text-align: center;'> معیار، ماشین جستجوگری هوشمند است که در هر ثانیه و بدون نیاز به کمک هیچ انسانی، به انتخاب های شما گوش فرا می دهد و برای شکل گیری خانواده ای جدید کوشش می کند. ماشین معیار، هدف اقتصادی ندارد و بدون نیاز به کسب حقوق این کار را انجام می دهد. چند کلیک می تواند شما را از کوتاه ترین راه در نقطه آغازین رابطه ای سالم قرار دهد.</h5>", unsafe_allow_html=True )
