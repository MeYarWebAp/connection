...
if (num00==sp):
    ...
    st.markdown('<a style="text-align: center;color:blue">معیارها و ویژگی های شما در مراجعه بعدی به طور خود به خود بار گذاری می شوند هر چند می توانید آن ها را هر لحظه تغییر دهید </a>', unsafe_allow_html=True)
