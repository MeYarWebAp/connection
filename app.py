...
with st.expander(""):
    st.markdown("<h6 style='text-align: center;'>معیار، ماشین جستجوگری هوشمند است که در هر ثانیه و بدون نیاز به کمک هیچ انسانی، دقیقا به انتخاب های شما گوش فرا می دهد و برای شکل گیری خانواده ای جدید، به طور آنلاین، لینک های قابل ارائه ای را به شما پیشنهاد می کند. ماشین معیار، هدف اقتصادی ندارد و بدون نیاز به کسب حقوق این کار را انجام می دهد. چند کلیک می تواند شما را از کوتاه ترین راه، در نقطه آغازین رابطه ای سالم قرار دهد. معیار، ماموریتی بیش از لینک کردن ندارد و پس از انجام معرفی اولیه ماشینی، فرض را بر اعتماد به هم و هوشمندی کاربران خود می گذارد</h6>", unsafe_allow_html=True )
