...
with st.expander(""):
    st.markdown("<h5 style='text-align: center;'>معیار، ماشین جستجوگری هوشمند است که در هر ثانیه و بدون نیاز به کمک هیچ انسانی یا واسطه ای غیر ازکاربر، به سلیقه ها و انتخاب های شما گوش فرا می دهد و برای شکل گیری خانواده ای جدید، به طور آنلاین، لینک های قابل ارائه ای که معیارهای شما را دارا هستند به شما پیشنهاد می کند. معیار، این کار را بر اساس درجه سخت گیری ای که خود شما تعیین می کنید، انجام می دهد. ماشین معیار، هدف اقتصادی ندارد و بدون نیاز به کسب حقوق، به طورخودکار، ۲۴ ساعته و هر ثانیه کار خود را انجام می دهد. معیار، ماموریتی بیشتر از لینک کردن برای خود تعریف نکرده. پس ازچند کلیک و کمی صبر، کسانی که معیارهای شما را کسب کرده اند، به شما می شناساند. معیار، پس از آن  فرض را بر اعتماد و هوشمندی خود شما می گذارد</h5>", unsafe_allow_html=True )
...
if (num00==sp):
    ...
    st.markdown('<div style="text-align: center;color:Gray">معیارها و ویژگی های شما به طور خود به خود بار گذاری می شوند هر چند می توانید آن ها را هر لحظه تغییر دهید </div>', unsafe_allow_html=True)
