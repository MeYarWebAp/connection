...
with st.expander(""):
    st.markdown("<h5 style='text-align: center;color:lightblue'>معیار، ماشین جستجوگری هوشمند است که بدون نیاز به کسب درآمد، به طورخودکار، ۲۴ ساعته و هر ثانیه و بدون نیاز به کمک هیچ واسطه ای غیر از خود شما، به سلیقه ها و انتخاب های شما به طور دقیق گوش فرا می دهد و برای شکل گیری خانواده ای جدید، به طور آنلاین، لینک هایی که معیارهای شما را دارا هستند به شما پیشنهاد می کند. معیار، این کار را بر اساس درجه سخت گیری ای که خود شما تعیین می کنید، انجام می دهد. معیار،  ماموریتی بیشتر از لینک کردن برای خود تعریف نکرده است. پس ازچند کلیک و کمی صبر، کسانی که معیارهای شما را کسب کرده اند را، به شما می شناساند. معیار، فرض را بر قدرت انتخاب، اعتماد و هوشمندی شما می گذارد.</h5>", unsafe_allow_html=True )
