...
if page=='درباره معیار':
    with col130:
        st.markdown("<h5 style='direction: rtl;'>معیار، سیستمی اتوماتیک و آنلاین است. معیاررایگان بوده و مثل یک ماشین هوشمند و بدون دخالت هیچ کسی ۲۴ ساعته کار و جستجو می کند و در لحظه، افراد مورد نظر شما را بر اساس معیارهایی که خود شما وارد می کنید به شما معرفی می کند.</h5>", unsafe_allow_html=True)
        st.stop()
